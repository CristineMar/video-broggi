<template>
  <div class="mt-3 container-video">
    ...
    <video id="myVideo" :width="width" :height="height" src="../assets/videos/helpVideo.mp4"></video>
    <br />
    <div v-if="question === true" style="display: flex;">
      <v-btn
        elevation="2"
        @click="answer(1)"
        class="m-2"
...
export default {
  data() {
    return {
      title: "Video d'Ajuda",
      videoUrl: "../assets/videos/helpVideo.mp4",
      width: "100%",
      height: "550px",
      question: false,
      intervalTime: 0,
